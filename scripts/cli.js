...
const contractABI = require("../artifacts/contracts/Powerampomen.sol/Powerampomen.json").abi;

program
    .name("powerampomen-cli")
    .description("CLI tool for Powerampomen smart contract")
    .version("1.0.0");
