 ...
 * This file demonstrates how to integrate Powerampomen with a web frontend
 */

// For React/Vue/Angular applications
export class PowerampomenClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PowerampomenClient(provider, contractAddress);
